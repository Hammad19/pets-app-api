...
{
    const { accessories_name, accessories_description, accessories_price, accessories_image, accessories_category, accessories_quantity, accessories_shared_by, type } = req.body;
    try 
    {
...
export const getAllAccessories = async (req, res) =>
{
    ...
    try 
    {
        const accessories = await Accessories.find({is_deleted: false , is_active: true });
        if (accessories) 
        {
            res.status(200).json({
...
{
    const {_id , accessories_name, accessories_description, accessories_price, accessories_image, accessories_category,accessories_quantity,accessories_shared_by} = req.body;
    try
    {
